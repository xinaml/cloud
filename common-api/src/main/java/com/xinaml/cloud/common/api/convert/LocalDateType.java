package com.xinaml.cloud.common.api.convert;
...
public class LocalDateType implements EnhancedUserType, Serializable {
    ...
    private static final long serialVersionUID = -4667485420464297159L;

    private static final int[] SQL_TYPES = new int[]{Types.DATE};//指定在数据库中的类型
    ...
    public Class<?> returnedClass() {
        return LocalDate.class;//指定要反正自定义类型
    }
    ...
    public void nullSafeSet(PreparedStatement preparedStatement, Object value, int index, SessionImplementor session)
        ...
        if (value == null) {
            ...
            StandardBasicTypes.DATE.nullSafeSet(preparedStatement, timestamp, index, session);
        }
    }
